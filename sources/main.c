...
/*   Updated: 2018/02/28 21:19:05 by pgritsen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_obj	objs[] = {
	{0xFF0000, 0, {1.4, 0, .86},  {0, 0, 0}, 1, 8, 0},
	{0x00FF00, 0, {-.5, 0, .86},  {0, 0, 0}, 1, 8, 0},
	{0xFFFF00, 0, {.5, 0, -.86},  {0, 0, 0}, 1, 8, 0},
	{0x00FFFF, 0, {.5, 1.6, .3},  {0, 0, 0}, 1, 8, 0},
	{0xC0C0C0, 3, {0, -1.4, 0}, {0, 1, 0}, 0, 2, 0.4},
	{.type = -1}
};

t_light	light[] = {
	{.type = 0, .intens = 0.1},
	{.type = 1, .intens = 0.9, .pos = {4, 4, 0}},
	{.type = -1}
};
